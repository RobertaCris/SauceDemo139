...
#line hidden
            ...
            else
            {
                this.ScenarioStart();
#line 5
        testRunner.Given("que acesso a página incial do site PO", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Dado ");
#line hidden
#line 6
        testRunner.When(string.Format("preencho o usuário como {0} PO", usuario), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Quando ");
#line hidden
#line 7
        testRunner.And(string.Format("a senha {0} e clico no botão Login PO", senha), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "E ");
#line hidden
#line 8
...
#line hidden
#line 10
        testRunner.And("clico no ícone do carrinho de compras PO", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "E ");
#line hidden
#line 11
        testRunner.Then(string.Format("exibe a pagina do carrinho com a quantidade {0} PO", quantidade), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Então ");
#line hidden
#line 12
        testRunner.And(string.Format("o nome do produto {0} PO", produto), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "E ");
#line hidden
#line 13
        testRunner.And(string.Format("o preço como {0} PO", preco), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "E ");
#line hidden
            }
